# n OpenAPI Specification
[![Build Status](https://travis-ci.org/kpritam/travis-ci-sample.svg?branch=master)](https://travis-ci.org/kpritam/travis-ci-sample)
...
6. If you did everything correct, https://kpritam.github.io/travis-ci-sample/ will lead to your new docs
...
- Documentation(ReDoc): https://kpritam.github.io/travis-ci-sample/
- Look full spec:
    + JSON https://kpritam.github.io/travis-ci-sample/swagger.json
    + YAML https://kpritam.github.io/travis-ci-sample/swagger.yaml
- Preview spec version for branch `[branch]`: https://kpritam.github.io/travis-ci-sample/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://kpritam.github.io/travis-ci-sample/ with url from the message: `Server started <url>`
